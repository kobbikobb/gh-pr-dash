...
func TestRenderTerminal(t *testing.T) {
	rows := []Row{
		{Tier: tierNeedsAction, IdleDays: 13, CI: "fail", Merge: "clean", Review: "none", Ref: "glint#20", Repository: "glint", URL: "https://github.com/me/glint/pull/20"},
		{Tier: tierReady, IdleDays: 2, CI: "ok", Merge: "clean", Review: "approved", Ref: "api#5", Repository: "api", URL: "https://github.com/me/api/pull/5", Comments: 3},
	}
